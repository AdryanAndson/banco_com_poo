...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\nDesculpe, saldo insuficiente para realizar esta operação.")
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            ...
            print("\nOperação não realizada. Limite de saques atingido.")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\nCliente não encontrado, impossível criar a conta.")
        return
